...
function App() {
  ...
  // FORCE DEV MODE: Always show test mode selector in all environments
  ...
  if (isDevelopmentMode && !showTestSelector) {
    return (
      <ErrorBoundary>
        ...
        {/* Start Over Button moved to lower left (Development Only - Toggle with Ctrl+Shift+S) */}
        {showStartOverButton && (
          <button
            onClick={handleResetToTestMode}
            className="fixed bottom-6 left-6 z-50 px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white text-sm font-medium rounded-lg shadow-lg transition-colors flex items-center gap-2"
